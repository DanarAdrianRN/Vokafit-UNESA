...
export const FeaturesSection: React.FC = () => {
  ...
  const description =
    "Everything you need to build modern applications, from development to deployment.";
  ...
  const features = [
    {
      ...
      description:
        "Built for speed with optimized architecture and modern best practices.",
    },
    {
  ...
  return (
    <section ref={containerRef} id="features" className="py-20 px-6 bg-zinc-50">
